...
class AddAccountantForm extends Form
{
    public function __construct($controller, $name)
    {
        ...
        $upload->setFolderName('Accountants-Profile-Images');
    ...
    public function save($data, $form,  HTTPRequest $request)
    {
        ...
        if (!empty($data['Email']))
        {
            ...
            if ($member)
            {
                ...
                return $this->controller->redirect("dashboard/accountants/");
            }
        }
        ...
        $member->write();
        $member->addToGroupByCode("accountants");
