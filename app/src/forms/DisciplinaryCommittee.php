...
class AddDisciplinaryCommitteeForm extends Form
{
    public function __construct($controller, $name)
    {
        ...
        $upload->setFolderName('DC-Profile-Images');
    ...
    public function save($data, $form,  HTTPRequest $request)
    {
        ...
        if (!empty($data['Email']))
        {
            ...
            if ($member)
            {
                ...
                return $this->controller->redirect("dashboard/disciplinary-committee/");
            }
        }
        ...
        $member->write();
        $member->addToGroupByCode("disciplinarycommittee");
